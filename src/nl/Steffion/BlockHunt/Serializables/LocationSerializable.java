...
{
    public LocationSerializable(World world, double x, double y, double z, float yaw,
            float pitch)
    {
    ...
    {
        super(loc.getWorld(), loc.getX(), loc.getY(), loc.getZ(), loc.getYaw(), loc
                .getPitch());
    }
    ...
    public static LocationSerializable deserialize(Map<String, Object> map)
    {
        ...
        return new LocationSerializable(w, (Double) M.g(map, "x", 0D), (Double) M.g(map,
                "y", 0D), (Double) M.g(map, "z", 0D),
