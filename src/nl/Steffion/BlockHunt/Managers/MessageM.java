...
public class MessageM
{
    ...
    public static void sendMessage(Player player, String message, String... vars)
    {
        if (player == null)
        {
            Bukkit.getConsoleSender().sendMessage(
                    MessageM.replaceAll(message.replaceAll("%player%", "Console"), vars));
        }
        else
        {
    ...
    public static void sendFMessage(Player player, ConfigC location, String... vars)
    {
        ...
        {
            Bukkit.getConsoleSender().sendMessage(
                    MessageM.replaceAll(location.config.getFile().get(location.location)
                            .toString().replaceAll("%player%", "Console"), vars));
        }
        else
        {
            player.sendMessage(MessageM.replaceAll(
    ...
    {
        return MessageM.replaceColours(MessageM.replaceColourVars(MessageM.replaceVars(
                message, vars)));
    }
